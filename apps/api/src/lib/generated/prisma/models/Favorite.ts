...
export type FavoriteWhereInput = {
  ...
  username?: Prisma.StringFilter<"Favorite"> | string
...
export type FavoriteScalarWhereWithAggregatesInput = {
  ...
  username?: Prisma.StringWithAggregatesFilter<"Favorite"> | string
...
export type FavoriteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"username" | "addedAt", ExtArgs["result"]["favorite"]>
...
export interface FavoriteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const favoriteWithUsernameOnly = await prisma.favorite.findMany({ select: { username: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Favorites and only return the `username`
   * const favoriteWithUsernameOnly = await prisma.favorite.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Favorites and only return the `username`
   * const favoriteWithUsernameOnly = await prisma.favorite.updateManyAndReturn({
   *   select: { username: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface FavoriteFieldRefs {
  readonly username: Prisma.FieldRef<"Favorite", 'String'>
